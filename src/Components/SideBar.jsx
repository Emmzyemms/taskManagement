        ...
        <div>
          ...
          {isSideBarOpen && (
            <div className=" bg-white  dark:bg-[#2b2c37]    w-full   py-4 rounded-xl">
              <h3 className=" dark:text-gray-300  text-gray-600 font-semibold mx-4 m ">
                ALL BOARDS ({boards?.length})
              </h3>

              <div className="  dropdown-borad flex flex-col h-[60vh]  justify-between mt-6 ">
                <div>
          ...
          {isSideBarOpen ? (
            <div
              ...
              className=" flex  items-center mt-5 absolute bottom-16  text-lg font-bold  rounded-r-full hover:text-[#635FC7] cursor-pointer mr-6 mb-1 px-8 py-4 hover:bg-[#635fc71a] dark:hover:bg-white  space-x-2 justify-center  my-5 text-gray-500 "
            >
              <img
